...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('questionnaires_core_path', null,
                    $modx->getOption('core_path') . 'components/questionnaires/') . 'model/';
            $modx->addPackage('questionnaires', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/questionnaires/model/schema/questionnaires.mysql.schema.xml';
